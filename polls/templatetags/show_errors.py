...
def show_errors(parser, token):
    ...
    try:
        ...
        raise template.TemplateSyntaxError("show_errors tag requires at least one argument")
...
class ShowErrorsNode(template.Node):
    ...
    def render(self, context):
        ...
        try:
            ...
            raise template.TemplateSyntaxError("show_errors arguments must be forms")
